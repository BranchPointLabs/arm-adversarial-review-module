...
export function EyeIcon() {
  return (
    <svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
      <path d="M1.8 8s2.3-4 6.2-4 6.2 4 6.2 4-2.3 4-6.2 4-6.2-4-6.2-4z" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
...
export function ImageIcon() {
  return (
    <svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
      ...
      <path d="m3.2 11 3.1-3.1 2.2 2.2 1.4-1.4 2.9 2.9" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
      <circle cx="10.8" cy="5.9" r="1" fill="currentColor" />
    </svg>
  );
}
